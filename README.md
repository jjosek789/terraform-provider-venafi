...
`tls_server` application:
   ...
   | `csr_origin`        | [String](https://www.terraform.io/docs/extend/schemas/schema-types.html#typestring) | Origin of the CSR: `local` (CSR generated locally), `service` (CSR generated by platform), or `file` (user-provided CSR via `csr_pem` attribute)                                                  | `local`                                                                                            |
   | `csr_pem`           | [String](https://www.terraform.io/docs/extend/schemas/schema-types.html#typestring) | CSR PEM data when `csr_origin` is `file`. Use `csr_pem = file("path/to/csr.pem")` or provide raw CSR PEM string                                                                                   | `none`                                                                                             |
